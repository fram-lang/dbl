...
let rec tr_ctor_pattern (p : Raw.expr) =
  ...
  | EWildcard | ENum64 _ | ENum _ | EStr _ | EParen _ | EVar _ | EImplicit _
...
let rec tr_function_arg (arg : Raw.expr) =
  ...
  | EWildcard | EUnit | ENum64 _ | ENum _ | EStr _ | EVar _ | EImplicit _ | ECtor _
...
let rec tr_let_pattern ~public (p : Raw.expr) =
  ...
  | EApp(p1, ps) ->
    ...
    | EUnit | ENum _ | ENum64 _ | EStr _ | ECtor _ | ESelect _ | EList _ ->
  ...
  | EWildcard | EUnit | ENum _ | ENum64 _ | EStr _ | EParen _ | ECtor _ | EAnnot _
...
let rec tr_poly_expr (e : Raw.expr) =
  ...
  | ESelect(path, e) ->
    ...
    | EWildcard | ENum _ | ENum64 _ | EStr _ | EParen _ | EFn _ | EApp _
