...
%token KW_AND KW_DATA KW_EFFECT KW_END KW_EXTERN KW_FINALLY KW_FN KW_HANDLE
%token KW_HANDLER KW_IMPLICIT KW_IN KW_LABEL KW_LET KW_MATCH KW_METHOD KW_OF
%token KW_REC KW_RETURN KW_TYPE KW_WITH
%token UNDERSCORE
%token EOF
